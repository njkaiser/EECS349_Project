...
# TODO: NEED TO CREATE INPUT LAYER
...
layer_pool1 = tf.layers.max_pooling2d(inputs=conv1, pool_size=POOL1_FILTER_SIZE, strides=POOL1_STRIDE)
...
layer_pool2 = tf.layers.max_pooling2d(inputs=conv2, pool_size=POOL2_FILTER_SIZE, strides=POOL2_STRIDE)

pool2_flat = tf.reshape(pool2, [-1, 7 * 7 * 64])

dense = tf.layers.dense(inputs=pool2_flat, units=FC1_NUM_NEURONS, activation=FC1_ACTIV_FUNC)

dropout = tf.layers.dropout(inputs=dense, rate=0.35, training=mode == learn.ModeKeys.TRAIN)
